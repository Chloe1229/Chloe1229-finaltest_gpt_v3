...
**현재 step1부터 step8까지 일부 기능을 제외한 나머지 작동이 streamlit에서 대부분 잘 구현되고 있습니다. 다만, 일부 문제가 확인된 step8에 대한 아래 사항이 최적화되어 작동되도록 재구성 및 수정을 제안해주세요.**
**아래에 작성된 내용 이외에는 이미 대부분의 기능이 잘 작동되므로 추가적인 수정은 진행하지 않습니다. 따라서 불필요한 수정 작업을 제안하지 말아주세요.**
***이미 작성된 step8에서 수정이 필요하거나 일부 작동되지 않는 기능을 개선하고자 하는 목적입니다. 따라서 요청한 사항 이외의 부분은 수정하지 않아야 합니다. 제안해주시는 작업으로 인해 다른 기능이 훼손되지 않도록 해주세요**
